...
//
    ...
    import XCTest
#if _runtime(_ObjC)
    public typealias NSObjectType = SwiftFoundation.NSObject
    public typealias ObjCBoolType = SwiftFoundation.ObjCBool
#else
    public typealias NSObjectType = Foundation.NSObject
    public typealias ObjCBoolType = Foundation.ObjCBool
#endif
#else
