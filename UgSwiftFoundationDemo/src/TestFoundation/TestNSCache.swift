...
//            ("test_setWithMutableKeys", test_setWithMutableKeys),
    ...
    func test_objectCorrectlyReleased() {
        ...
        var object1 = NSObjectType()
        weak var weakObject1: NSObjectType? = object1
        
        var object2 = NSObjectType()
        weak var weakObject2: NSObjectType? = object2
        
        var object3 = NSObjectType()
        weak var weakObject3: NSObjectType? = object3
        
        let object4 = NSObjectType()
        let object5 = NSObjectType()
        ...
        object1 = NSObjectType()
        object2 = NSObjectType()
        object3 = NSObjectType()
