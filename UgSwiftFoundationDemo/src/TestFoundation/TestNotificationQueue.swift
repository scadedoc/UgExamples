...
*/
    ...
    func test_postAsapToDefaultQueueWithCoalescingOnNameAndSender() {
        ...
        let notification = Notification(name: notificationName, object: NSObjectType())
        var numberOfCalls = 0
    ...
    func test_postAsapToDefaultQueueWithCoalescingOnNameOrSender() {
        ...
        let notification1 = Notification(name: notificationName, object: NSObjectType())
        ...
        let notification2 = Notification(name: notificationName, object: NSObjectType())
