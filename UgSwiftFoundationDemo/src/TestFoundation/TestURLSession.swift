...
#if os(Android)
            // error code detection is not implemented on Android
...
#if os(Android)
            // error code detection is not implemented on Android
            XCTAssertEqual((task.error as? URLError)?.code, .unknown)
#else
...
class SharedDelegate: SwiftFoundation.NSObject {
...
class SessionDelegate: SwiftFoundation.NSObject, URLSessionDelegate {
...
class DataTask : SwiftFoundation.NSObject {
...
class DownloadTask : SwiftFoundation.NSObject {
...
class HTTPRedirectionDataTask : SwiftFoundation.NSObject {
    let dataTaskExpectation: XCTestExpectation!
    var session: URLSession! = nil
    var task: URLSessionDataTask! = nil
    var cancelExpectation: XCTestExpectation?
...
class HTTPUploadDelegate: SwiftFoundation.NSObject {
