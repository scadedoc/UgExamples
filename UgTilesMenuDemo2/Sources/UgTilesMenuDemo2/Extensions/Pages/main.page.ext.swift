...
extension MainPageAdapter {
  ...
  var listView5: SCDWidgetsListView {
    return self.page?.getWidgetByName("listView5") as! SCDWidgetsListView
  }

  var image5: SCDWidgetsImage {
    return self.page?.getWidgetByName("image5") as! SCDWidgetsImage
  }
  ...
  var image7: SCDWidgetsImage {
    return self.page?.getWidgetByName("image7") as! SCDWidgetsImage
  }
